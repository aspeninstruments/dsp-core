...
// Surge is now an independent pipeline stage (SurgeStage) — the LUT no longer
// knows about surge mode. Edge slopes are tested via Linear extrapolation in
// SeamlessTransferFunctionTest.
